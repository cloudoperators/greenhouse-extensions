...
| operator.enabled | bool | `true` | Install the OpenSearch operator subchart and its cluster-wide resources (CRDs, ServiceMonitor, alerts). Set false on additional releases that reuse an operator deployed by another release. |
