...
| siem.indexTemplates | list | <pre>indexTemplates:<br>  - name: "siem-logs-index-template"<br>    indexPatterns:<br>      - "siem-logs*"<br>    dataStream: {}<br>    priority: 100<br>  - name: "siem-audit-index-template"<br>    indexPatterns:<br>      - "siem-audit*"<br>    dataStream: {}<br>    priority: 100</pre> | List of OpensearchIndexTemplate for SIEM cluster. |
| siem.ismPolicies | list | <pre>ismPolicies:<br>  - name: siem-logs-rollover-policy<br>    defaultState: hot<br>    description: "SIEM logs policy with 30-day retention and size-based rollover"<br>    ismTemplate:<br>      indexPatterns:<br>        - "siem-logs*"<br>      priority: 100<br>  - name: siem-audit-rollover-policy<br>    defaultState: hot<br>    description: "SIEM audit policy with 30-day retention and size-based rollover"<br>    ismTemplate:<br>      indexPatterns:<br>        - "siem-audit*"<br>      priority: 100</pre> | List of OpenSearchISMPolicy for SIEM cluster. Check values.yaml file for examples. |
| siem.nameOverride | string | `""` | Override the name used by the subchart. By default uses release name with -siem suffix |
| siem.roles | list | <pre>roles:<br>  - name: "siem-write-role"<br>    clusterPermissions:<br>      - "cluster_monitor"<br>    indexPermissions:<br>      - indexPatterns:<br>          - "siem-logs*"<br>        allowedActions:<br>          - "indices:admin/template/get"<br>  - name: "siem-audit-write-role"<br>    indexPermissions:<br>      - indexPatterns:<br>          - "siem-audit*"</pre> | List of OpensearchRole for SIEM cluster. See values.yaml file for a full example. |
