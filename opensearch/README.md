...
| cluster.apiGroup | string | `"opensearch.org"` | API group for OpenSearch CRDs. Use "opensearch.opster.io" (legacy) or "opensearch.org" (new) |
...
| cluster.cluster.bootstrap.annotations | object | `{}` | bootstrap pod annotations |
| cluster.cluster.bootstrap.env | list | `[]` | bootstrap pod env variables |
...
| cluster.cluster.dashboards.tls.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
...
| cluster.cluster.dashboards.topologySpreadConstraints | list | `[]` | dashboards pod topologySpreadConstraints |
...
| cluster.cluster.general.hostNetwork | bool | `false` | Enables host networking for all pods in the cluster. |
...
| cluster.cluster.general.monitoring.labels | object | `{}` | Additional labels to apply to the generated ServiceMonitor |
...
| cluster.cluster.initHelper.image | string | `"docker.io/busybox"` | initHelper image (overrides the default docker.io/busybox) |
...
| cluster.cluster.nodePools[0].additionalConfig | object | `{}` | Extra items to add to opensearch.yml for this specific nodepool (merged with general.additionalConfig) |
| cluster.cluster.nodePools[0].annotations | object | `{}` | node pool pod annotations |
| cluster.cluster.nodePools[0].sidecarContainers | list | `[]` | These containers will be deployed as sidecars in the same pod as the OpenSearch container |
...
| cluster.cluster.security.config.adminSecret | object | `{"name":"opensearch-admin-cert"}` | TLS Secret that contains a client certificate (tls.key, tls.crt, ca.crt) with admin rights in the opensearch cluster. Must be set if http certificates are provided by user and not generated |
...
| cluster.cluster.security.tls.http.adminDn | list | `[]` | DNs of certificates that should have admin access, mainly used for securityconfig updates via securityadmin.sh, only used when existing certificates are provided |
...
| cluster.cluster.security.tls.http.customFQDN | string | `""` | Optional custom FQDN to use for the HTTP certificate. |
| cluster.cluster.security.tls.http.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
| cluster.cluster.security.tls.http.enableHotReload | bool | `false` | Enable hot reloading of TLS certificates. |
...
| cluster.cluster.security.tls.transport.adminDn | list | `["CN=admin"]` | DNs of certificates that should have admin access, mainly used for securityconfig updates via securityadmin.sh, only used when existing certificates are provided. This field is deprecated and will be removed in a future version. For OpenSearch 2.0.0+, use security.tls.http.adminDn instead. |
...
| cluster.cluster.security.tls.transport.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
| cluster.cluster.security.tls.transport.enableHotReload | bool | `false` | Enable hot reloading of TLS certificates. |
...
| operator.manager.resources.limits.cpu | string | `"1000m"` |  |
| operator.manager.resources.limits.memory | string | `"500Mi"` |  |
| operator.manager.resources.requests.cpu | string | `"200m"` |  |
...
| operator.webhook.certManager.enabled | bool | `true` |  |
| operator.webhook.enabled | bool | `true` |  |
| operator.webhook.failurePolicy | string | `"Ignore"` |  |
| operator.webhook.port | int | `9443` |  |
| operator.webhook.secretName | string | `""` |  |
| siem.actionGroups | list | `[]` | List of OpensearchActionGroup for SIEM cluster. Check values.yaml file for examples. |
| siem.apiGroup | string | `"opensearch.org"` | API group for OpenSearch CRDs. Use "opensearch.opster.io" (legacy) or "opensearch.org" (new) |
...
| siem.cluster.bootstrap.annotations | object | `{}` | bootstrap pod annotations |
| siem.cluster.bootstrap.env | list | `[]` | bootstrap pod env variables |
...
| siem.cluster.dashboards.tls.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
...
| siem.cluster.dashboards.topologySpreadConstraints | list | `[]` | dashboards pod topologySpreadConstraints |
...
| siem.cluster.general.hostNetwork | bool | `false` | Enables host networking for all pods in the cluster. |
...
| siem.cluster.general.monitoring.labels | object | `{}` | Additional labels to apply to the generated ServiceMonitor |
...
| siem.cluster.general.operatorClusterURL | string | `""` | Optional custom URL for operator to communicate with OpenSearch |
...
| siem.cluster.initHelper.image | string | `"docker.io/busybox"` | initHelper image (overrides the default docker.io/busybox) |
...
| siem.cluster.nodePools[0].additionalConfig | object | `{}` | Extra items to add to opensearch.yml for this specific nodepool (merged with general.additionalConfig) |
| siem.cluster.nodePools[0].annotations | object | `{}` | node pool pod annotations |
| siem.cluster.nodePools[0].sidecarContainers | list | `[]` | These containers will be deployed as sidecars in the same pod as the OpenSearch container |
...
| siem.cluster.security.tls.http.adminDn | list | `[]` | DNs of certificates that should have admin access, mainly used for securityconfig updates via securityadmin.sh, only used when existing certificates are provided |
...
| siem.cluster.security.tls.http.customFQDN | string | `""` | Optional custom FQDN to use for the HTTP certificate. |
| siem.cluster.security.tls.http.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
| siem.cluster.security.tls.http.enableHotReload | bool | `false` | Enable hot reloading of TLS certificates. |
...
| siem.cluster.security.tls.transport.adminDn | list | `["CN=siem-admin"]` | DNs of certificates that should have admin access, mainly used for securityconfig updates via securityadmin.sh, only used when existing certificates are provided. This field is deprecated and will be removed in a future version. For OpenSearch 2.0.0+, use security.tls.http.adminDn instead. |
...
| siem.cluster.security.tls.transport.duration | string | `"8760h"` | Duration controls the validity period of generated certificates (e.g. "8760h", "720h"). This is used only when generate is true. |
| siem.cluster.security.tls.transport.enableHotReload | bool | `false` | Enable hot reloading of TLS certificates. |
