...
| cluster.users | list | `[{"backendRoles":[],"name":"logs","secretKey":"password","secretName":"logs-credentials"},{"backendRoles":[],"name":"logs2","secretKey":"password","secretName":"logs2-credentials"},{"backendRoles":[],"name":"dashboards","secretKey":"password","secretName":"dashboards-credentials"},{"backendRoles":[],"name":"dashboards2","secretKey":"password","secretName":"dashboards2-credentials"}]` | List of OpenSearch user configurations. Each user references a secret (defined in usersCredentials) for authentication. |
