...
tcp_log/syslog:
  ...
  #   RFC 3164 (zero-pad):   "<priority>Mmm DD HH:MM:SS ..." (NON-STANDARD, Fortinet / Cisco ACI)
  #                          e.g. "<44>Aug 04 07:50:05 eu-de-1-fw101b CEF:0|..."
  #   RFC 3164 (standard):   "<priority>Mmm _d HH:MM:SS ..."  e.g. "<13>Jan 15 10:30:00..." or "Aug  4 07:44:37"
  ...
  - type: router
    ...
    # Zero-padded day: must come BEFORE the standard RFC3164 route.
    # \d{2} explicitly requires two digits, distinguishing "Aug 04" from "Aug  4".
    - expr: 'body matches "^<\\d+>(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) \\d{2} "'
  ...
  # Zero-padded RFC3164 fallback (Fortinet, Cisco ACI, etc.)
  # Handles "<pri>Mmm DD HH:MM:SS HOSTNAME [TAG[PID]:] MESSAGE"
...
udp_log/syslog:
  ...
  # Zero-padded RFC3164 fallback (UDP)
  - type: regex_parser
...
tcp_log/syslog_tls:
  ...
  # Zero-padded RFC3164 fallback (TLS)
  - type: regex_parser
