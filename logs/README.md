...
| openTelemetry.collectorImage | object | `{"repository":"ghcr.io/cloudoperators/opentelemetry-collector-contrib","tag":"58b73f4"}` | OpenTelemetry Collector image configuration |
...
| openTelemetry.collectorImage.tag | string | `"58b73f4"` | Image tag for OpenTelemetry Collector |
...
| opentelemetry-operator.manager.image.tag | string | `"v0.145.0"` | overrides the default tag repository for the OpenTelemetry Operator image. |
