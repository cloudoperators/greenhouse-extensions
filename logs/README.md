...
| openTelemetry.collectorImage | object | `{"repository":"ghcr.io/cloudoperators/opentelemetry-collector-contrib","tag":"7685892"}` | OpenTelemetry Collector image configuration |
...
| openTelemetry.collectorImage.tag | string | `"7685892"` | Image tag for OpenTelemetry Collector |
