...
| openTelemetry.collectorImage | object | `{"repository":"ghcr.io/cloudoperators/opentelemetry-collector-contrib","tag":"5fa5a1d"}` | OpenTelemetry Collector image configuration |
...
| openTelemetry.collectorImage.tag | string | `"5fa5a1d"` | Image tag for OpenTelemetry Collector |
