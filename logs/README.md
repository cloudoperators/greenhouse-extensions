...
| openTelemetry.collectorImage | object | `{"repository":"ghcr.io/cloudoperators/opentelemetry-collector-contrib","tag":"253c794"}` | OpenTelemetry Collector image configuration |
...
| openTelemetry.collectorImage.tag | string | `"253c794"` | Image tag for OpenTelemetry Collector |
