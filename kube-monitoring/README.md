...
| kubeMonitoring.prometheus.prometheusSpec.storageSpec.volumeClaimTemplate.spec.storageClassName | string | `"gluster"` | The storage class to use for the persistent volume |
