...
| kubeMonitoring.prometheus.ingress.enabled | bool | `false` |  |
| kubeMonitoring.prometheus.ingress.ingressClassName | string | `"nginx"` |  |
...
| kubeMonitoring.prometheus.prometheusSpec.podMonitorSelector.matchLabels.plugin | string | `"{{ $.Release.Name }}"` |  |
| kubeMonitoring.prometheus.prometheusSpec.probeSelector.matchLabels.plugin | string | `"{{ $.Release.Name }}"` |  |
| kubeMonitoring.prometheus.prometheusSpec.ruleSelector.matchLabels.plugin | string | `"{{ $.Release.Name }}"` |  |
| kubeMonitoring.prometheus.prometheusSpec.scrapeConfigSelector.matchLabels.plugin | string | `"{{ $.Release.Name }}"` |  |
| kubeMonitoring.prometheus.prometheusSpec.secrets[0] | string | `"tls-prometheus-{{ .Release.Name }}"` |  |
| kubeMonitoring.prometheus.prometheusSpec.serviceMonitorSelector.matchLabels.plugin | string | `"{{ $.Release.Name }}"` |  |
...
| kubeMonitoring.prometheus.prometheusSpec.storageSpec.volumeClaimTemplate.spec.resources.requests.storage | string | `"50Gi"` |  |
