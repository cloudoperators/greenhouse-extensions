          ...
          violation_groups: [
            {
              pattern: {
                ...
                namespace: "nms-2",
                message:
                  "bvcbvc gfhgfhgf bvcbvcbvc bvnbvbc trytr gfgfhg kjkjhjkh nbnbnb bvnbvnbv nbvbvnbv nbvbnv.",
                object_identity: { service: "none", support_group: "none" },
              },
          ...
          violation_groups: [
            {
              pattern: {
                ...
                name: "violation-group-1",
                message:
                  "jhgjhgjh hjhgjhg mbnbnvbnbvnbv jyughghg hghghfghgfghf nvnbvnbvnbv nbnbvnvbnbv nbvnvbnbvnbv nbnbvnbvbn nbvnbvnbv.",
                object_identity: { service: "none", support_group: "none" },
              },
              instances: [{ cluster: "cluster-4" }, { cluster: "cluster-5" }],
            },
            {
              pattern: {
                kind: "violation-kind-2",
                name: "violation-group-2",
                message:
                  "bnbnbv nnbvnbv nbvnbvbnv nbvnbvnbv nbvnbvnbv bvnbvnbv nbvnbvnbv nvbnbvnbv.",
                object_identity: { service: "none", support_group: "none" },
              },
              instances: [{ cluster: "cluster-5" }, { cluster: "cluster-12" }],
            },
            {
              pattern: {
                kind: "violation-kind-3",
                name: "violation-group-4",
                message:
                  "hjhjghjg hghgfhgf bvbcvbvc ytuytuyt qrewerwerw bvbvcbvbvcbcvb nbnbvnbvnbv nbvnbvnbv nbvnbvnbv nbvnbvnbv nbvnbvnbv.",
                object_identity: { service: "none", support_group: "none" },
              },
              instances: [{ cluster: "cluster-7" }, { cluster: "cluster-14" }],
            },
            {
              pattern: {
                kind: "violation-kind-4",
                name: "violation-group-5",
                message:
                  "bnbnb nbnbvnbv nbvnbvnbv tuytuyt vhghjgh mnbmnbmnb nbnbnmbmnb nbmnbmnb nbnmbmnbm bnbnmbbnb nmbnbnbn mnbmnbnbn nbmnbnmb.",
                object_identity: {
                  service: "none",
                  support_group: "support-group-2",
                },
              },
              instances: [{ cluster: "cluster-7" }, { cluster: "cluster-8" }],
            },
          ],
        },
      ],
      ...
      constraints: [
        {
          ...
          metadata: {
            ...
            docstring:
              "Tjhgjhgjhg nhgfhgf nbvbnvb bvbvcbvc bcbvcbvc vcbcbvc bvcbvcvc bvbvcbvcbv bcvc.\n\n#### hjhkghfg hgfhgfhgf bvhgfhgfhgf?\n\nBkjjhgjhg,mb nbvbnvbvc utyuytuyt. bvcbvcbvcbv bgfdgfdgf vvcxvcxz vcvcvcc, hjghgfhgf bvcbvcvc tyrytr bvnbnb mn,mn,mn mnmnnbhg fdsfdsdf ewewcvx cxvcxcv.\n",
          },
          violation_groups: [
            {
              pattern: {
                kind: "violtion-kind-5",
                name: "violation-group-1",
                namespace: "\nnms-3\u003e",
                message:
                  "hgjhg bvnbvbvc gftrt vcfddfgfdfd bvbvbvcbvc hgfghfgh yutytyu bvbbv nmbnbnb nbvbvbv nbvnbvbv vcxvcxc x rerere bvcvbbv bvcbvc.",
                object_identity: { service: "none", support_group: "none" },
              },
              instances: [
                {
            ...
            {
              pattern: {
                kind: "violation-kind-5",
                name: "violation-group-4",
                namespace: "nms-5",
                message:
                  "mbnbbnv nvnbvnbv hhghghgfhgf bvbvbv nvnbvnbv bnnmbvnmb hghghfg dffdgf nvnvnbv nvbnbvbnv nbvnbvbnv bvv.",
                object_identity: {
                  service: "none",
                  support_group: "support-group-4",
                },
              },
              instances: [
                { cluster: "cluster-1" },
            ...
            },
            {
              pattern: {
                ...
                namespace: "nms-6",
                message:
                  "hjjhj jgjhgjgh jhgjhgjhg jhgjhgjhg hjgjhgjhg. jhgjhg vhgjhg nbvnbvnv jhghjghg nnvv nbnbnbvbv nbvbvbvb.",
                object_identity: {
                  service: "none",
                  support_group: "support-group-5",
                },
              },
              instances: [
                { cluster: "cluster-1" },
            ...
            {
              pattern: {
                kind: "violation-kind-6",
                name: "violation-group-6",
                namespace: "nms-7",
                message:
                  "nbmnb nghjghg nbvnbvnb nbvnvbn. jhgjhg nbvbnv nbvbnvbn bvbnvbnv hghgh bnvnbvbnv nbvbv",
                object_identity: {
                  service: "none",
                  support_group: "support-group-6",
                },
              },
              instances: [
                { cluster: "cluster-1" },
