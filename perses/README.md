...
| perses.config.frontend.information | string | "Add your information here. This will be displayed on the home page of Perses." | Information contains markdown content to be displayed on the Perses home page. |
